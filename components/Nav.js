        ...
        <>
            <nav className="flex justify-between md:justify-start items-center max-w-2xl">
                <div className="-ml-8 md:ml-0">
                    <Image className="object-contain" src="https://static.wixstatic.com/media/4aa103_7523676b913e458097b002b060b4b3f1~mv2.png/v1/fill/w_275,h_245,al_c,q_85,usm_0.66_1.00_0.01/Rookbook%20LOGO%20(2).webp" width={200} height={100} />
                </div>
